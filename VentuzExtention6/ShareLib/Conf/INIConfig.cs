...
namespace ShareLib.Conf
{
    public class INIConfig
    {
        ...
        public INIConfig(Stream stm)
            : this(new StreamReader(stm))
        {
        }

        public INIConfig(StreamReader fileStream)
        {
            try
            {
        ...
        public void Dump()
        {
            ...
            {
                System.Console.WriteLine($"[{ dm.Key }]");
                foreach(var cf in dm.Value)
                {
                    System.Console.WriteLine($"{cf.Key}={cf.Value}");
                }
            }
        }
